...
```
## Examination of nlmixr2 estimation algorithm properties for richly sampled data and multiple models

The nlmixr2/SAEM, and nlmixr2/FOCEI parameter estimation algorithms were
...
readData <- function(nlmixrVersion=c("1.1.1.3"), est=c("saem", "focei", "nlme"),
    ...
    .ret <- lapply(seq_along(.ret$ver), function(x){
        ...
        .f <- file.path(system.file(package="nlmixr2examples"), "models", .c["src"]);
        if (file.exists(.f)){
            source(.f)
