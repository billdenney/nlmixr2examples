...
# remotes::install_github("nlmixr2/nlmixr2examples")
library(nlmixr2examples) # For nlmixr2examples data
...
plot(fit); ## Standard nlmixr2 plots

################################################################################
## Xpose plots; Need to print otherwise running a script won't
## show xpose plots
################################################################################
xpdb <- xpose_data_nlmixr(fit) ## first convert to nlmixr2 object
